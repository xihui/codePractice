...
public class SeqOfShortSeqTTypeSupport extends TypeSupportImpl {
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  SeqOfShortTTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (3));
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  SeqOfShortTTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
	...
	Object sample) 
    {
        ...
        currentAlignment += SeqOfShortTTypeSupport.get_instance().get_sequence_serialized_size(
...
SeqOfShortSeqT typedSrc = (SeqOfShortSeqT) src;    
        ...
        SeqOfShortTTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,(3),endpoint_plugin_qos);
...
SeqOfShortSeqT typedDst = (SeqOfShortSeqT) dst;
            ...
            typedDst.clear();
            SeqOfShortTTypeSupport.get_instance().deserialize_sequence(
...
SeqOfShortSeqT typedDst = (SeqOfShortSeqT) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            SeqOfShortTTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);

 ...
 * TopStructExtended.
 */
public class TopStructExtendedTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::TopStructExtended";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    
    public static final int LAST_MEMBER_ID = 
        (TopStructTypeSupport.LAST_MEMBER_ID + 1);
    

    private static final TopStructExtendedTypeSupport _singleton
        = new TopStructExtendedTypeSupport();
     ...
     */
    public static TopStructExtendedTypeSupport get_instance() {
        return _singleton;
    }

    public static TopStructExtendedTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return TopStructExtended.create();
    }
    ...
    public Class get_type() {
        return TopStructExtended.class;
    }
     ...
     * <code>this</code> is not a <code>TopStructExtended</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TopStructExtended typedDst = (TopStructExtended) destination;
        TopStructExtended typedSrc = (TopStructExtended) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += TopStructTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        if(include_encapsulation) {
            ...
            currentAlignment += TopStructTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TopStructExtended typedSrc = (TopStructExtended) sample;
        ...
        currentAlignment += TopStructTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,sample);

        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.extendedMember);
...
TopStructExtended typedSrc = (TopStructExtended) src;    
        TopStructTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
        
        dst.writeString(typedSrc.extendedMember,(255));
...
TopStructExtended typedDst = (TopStructExtended) dst;
        
            typedDst.clear();        TopStructTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
        
    try {

            typedDst.extendedMember = src.readString((255));
...
TopStructExtended typedDst = (TopStructExtended) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
TopStructTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TopStructExtended typedDst = (TopStructExtended) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TopStructExtendedDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TopStructExtendedDataReader(native_reader, listener, mask, this);                
    ...
    protected TopStructExtendedTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TopStructExtendedTypeCode.VALUE,TopStructExtended.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TopStructExtendedTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TopStructExtendedTypeCode.VALUE,TopStructExtended.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

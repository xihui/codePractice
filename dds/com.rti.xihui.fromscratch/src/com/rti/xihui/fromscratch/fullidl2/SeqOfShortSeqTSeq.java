...
/**
 * A sequence of SeqOfShortSeqT instances.
 */
public final class SeqOfShortSeqTSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public SeqOfShortSeqTSeq() {
        super(SeqOfShortSeqT.class);
    }


    public SeqOfShortSeqTSeq(int initialMaximum) {
        super(SeqOfShortSeqT.class, initialMaximum);
    }


    public SeqOfShortSeqTSeq(Collection elements) {
        super(SeqOfShortSeqT.class, elements);
    }

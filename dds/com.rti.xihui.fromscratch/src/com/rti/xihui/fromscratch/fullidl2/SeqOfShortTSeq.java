...
/**
 * A sequence of SeqOfShortT instances.
 */
public final class SeqOfShortTSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public SeqOfShortTSeq() {
        super(SeqOfShortT.class);
    }


    public SeqOfShortTSeq(int initialMaximum) {
        super(SeqOfShortT.class, initialMaximum);
    }


    public SeqOfShortTSeq(Collection elements) {
        super(SeqOfShortT.class, elements);
    }

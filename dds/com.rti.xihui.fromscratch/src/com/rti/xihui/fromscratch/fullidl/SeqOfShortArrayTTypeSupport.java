 ...
 * SeqOfShortArrayT.
 */
public class SeqOfShortArrayTTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::SeqOfShortArrayT";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final SeqOfShortArrayTTypeSupport _singleton
        = new SeqOfShortArrayTTypeSupport();
     ...
     */
    public static SeqOfShortArrayTTypeSupport get_instance() {
        return _singleton;
    }

    public static SeqOfShortArrayTTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return SeqOfShortArrayT.create();
    }
     ...
     * <code>this</code> is not a <code>SeqOfShortArrayT</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        SeqOfShortArrayT typedDst = (SeqOfShortArrayT) destination;
        SeqOfShortArrayT typedSrc = (SeqOfShortArrayT) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.fullidl.ShortArrayTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (3));
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.fullidl.ShortArrayTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        SeqOfShortArrayT typedSrc = (SeqOfShortArrayT) sample;
        ...
        currentAlignment += com.rti.xihui.fromscratch.fullidl.ShortArrayTypeSupport.get_instance().get_sequence_serialized_size(
...
SeqOfShortArrayT typedSrc = (SeqOfShortArrayT) src;    
        ...
        com.rti.xihui.fromscratch.fullidl.ShortArrayTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,(3),endpoint_plugin_qos);
...
SeqOfShortArrayT typedDst = (SeqOfShortArrayT) dst;
        
            typedDst.clear();
            com.rti.xihui.fromscratch.fullidl.ShortArrayTypeSupport.get_instance().deserialize_sequence(
                endpoint_data, typedDst.userData, src, 
                (3), endpoint_plugin_qos);            
...
SeqOfShortArrayT typedDst = (SeqOfShortArrayT) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.xihui.fromscratch.fullidl.ShortArrayTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
SeqOfShortArrayT typedDst = (SeqOfShortArrayT) sample;
    ...
    protected SeqOfShortArrayTTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SeqOfShortArrayTTypeCode.VALUE,SeqOfShortArrayT.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected SeqOfShortArrayTTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,SeqOfShortArrayTTypeCode.VALUE,SeqOfShortArrayT.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

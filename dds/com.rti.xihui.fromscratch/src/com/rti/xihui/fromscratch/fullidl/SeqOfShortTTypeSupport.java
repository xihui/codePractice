 ...
 * SeqOfShortT.
 */
public class SeqOfShortTTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::SeqOfShortT";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final SeqOfShortTTypeSupport _singleton
        = new SeqOfShortTTypeSupport();
     ...
     */
    public static SeqOfShortTTypeSupport get_instance() {
        return _singleton;
    }

    public static SeqOfShortTTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return SeqOfShortT.create();
    }
     ...
     * <code>this</code> is not a <code>SeqOfShortT</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        SeqOfShortT typedDst = (SeqOfShortT) destination;
        SeqOfShortT typedSrc = (SeqOfShortT) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, ((com.rti.xihui.fromscratch.fullidl.SEQ_SIZE.VALUE)));
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        SeqOfShortT typedSrc = (SeqOfShortT) sample;
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceSerializedSize(currentAlignment, typedSrc.userData);
...
SeqOfShortT typedSrc = (SeqOfShortT) src;    
        ...
        dst.writeShortSeq(typedSrc.userData,((com.rti.xihui.fromscratch.fullidl.SEQ_SIZE.VALUE)));
...
SeqOfShortT typedDst = (SeqOfShortT) dst;
        
            typedDst.clear();
            src.readShortSequence(
                typedDst.userData,
                ((com.rti.xihui.fromscratch.fullidl.SEQ_SIZE.VALUE)));
...
SeqOfShortT typedDst = (SeqOfShortT) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
SeqOfShortT typedDst = (SeqOfShortT) sample;
    ...
    protected SeqOfShortTTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SeqOfShortTTypeCode.VALUE,SeqOfShortT.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected SeqOfShortTTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,SeqOfShortTTypeCode.VALUE,SeqOfShortT.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

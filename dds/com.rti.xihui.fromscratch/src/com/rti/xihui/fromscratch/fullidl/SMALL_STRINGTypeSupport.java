 ...
 * SMALL_STRING.
 */
public class SMALL_STRINGTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::SMALL_STRING";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final SMALL_STRINGTypeSupport _singleton
        = new SMALL_STRINGTypeSupport();
     ...
     */
    public static SMALL_STRINGTypeSupport get_instance() {
        return _singleton;
    }

    public static SMALL_STRINGTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return SMALL_STRING.create();
    }
     ...
     * <code>this</code> is not a <code>SMALL_STRING</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        SMALL_STRING typedDst = (SMALL_STRING) destination;
        SMALL_STRING typedSrc = (SMALL_STRING) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        SMALL_STRING typedSrc = (SMALL_STRING) sample;
...
SMALL_STRING typedSrc = (SMALL_STRING) src;    
        ...
        dst.writeString(typedSrc.userData,((com.rti.xihui.fromscratch.fullidl.STRING_SIZE.VALUE)));
...
SMALL_STRING typedDst = (SMALL_STRING) dst;
        
            typedDst.clear();
            typedDst.userData = src.readString(((com.rti.xihui.fromscratch.fullidl.STRING_SIZE.VALUE)));
...
SMALL_STRING typedDst = (SMALL_STRING) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
SMALL_STRING typedDst = (SMALL_STRING) sample;
    ...
    protected SMALL_STRINGTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SMALL_STRINGTypeCode.VALUE,SMALL_STRING.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected SMALL_STRINGTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,SMALL_STRINGTypeCode.VALUE,SMALL_STRING.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

 ...
 * EnumExample.
 */
public class EnumExampleTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::EnumExample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final EnumExampleTypeSupport _singleton
        = new EnumExampleTypeSupport();    
    ...
    public static EnumExampleTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static EnumExampleTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = EnumExampleTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
EnumExample typedSrc = (EnumExample) src;   
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            dst = EnumExample.valueOf(ordinal);
    ...
    protected EnumExampleTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,EnumExampleTypeCode.VALUE,EnumExample.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);

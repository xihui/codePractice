 ...
 * ShortArray.
 */
public class ShortArrayTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::ShortArray";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final ShortArrayTypeSupport _singleton
        = new ShortArrayTypeSupport();
     ...
     */
    public static ShortArrayTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortArrayTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return ShortArray.create();
    }
     ...
     * <code>this</code> is not a <code>ShortArray</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        ShortArray typedDst = (ShortArray) destination;
        ShortArray typedSrc = (ShortArray) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.SHORT.getArrayMaxSizeSerialized(currentAlignment, (10));
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        ShortArray typedSrc = (ShortArray) sample;
...
ShortArray typedSrc = (ShortArray) src;    
        ...
        for(int i1__ = 0; i1__ < 10; ++i1__) {
            ...
            dst.writeShort(typedSrc.userData[i1__]);                
...
ShortArray typedDst = (ShortArray) dst;
        
            typedDst.clear();
            
        for(int i1__ = 0; i1__ < 10; ++i1__) {
        
                typedDst.userData[i1__] = src.readShort();        
...
ShortArray typedDst = (ShortArray) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
ShortArray typedDst = (ShortArray) sample;
    ...
    protected ShortArrayTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortArrayTypeCode.VALUE,ShortArray.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected ShortArrayTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,ShortArrayTypeCode.VALUE,ShortArray.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

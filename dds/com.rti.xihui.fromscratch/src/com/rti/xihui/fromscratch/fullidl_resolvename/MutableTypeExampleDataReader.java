...
/**
 * A reader for the MutableTypeExample user type.
 */
public class MutableTypeExampleDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(MutableTypeExampleSeq received_data, SampleInfoSeq info_seq,
             int max_samples,
    ...
    public void take(MutableTypeExampleSeq received_data, SampleInfoSeq info_seq,
             int max_samples,
             int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(MutableTypeExampleSeq received_data, 
    ...
    public void take_w_condition(MutableTypeExampleSeq received_data, 
                 SampleInfoSeq info_seq,
                 int max_samples,
                 ReadCondition condition) {
    ...
    public void read_next_sample(MutableTypeExample received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }


    public void take_next_sample(MutableTypeExample received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }


    public void read_instance(MutableTypeExampleSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(MutableTypeExampleSeq received_data, SampleInfoSeq info_seq,
            int max_samples, InstanceHandle_t a_handle, int sample_states,
            int view_states, int instance_states) {
      ...
      public void read_instance_w_condition(MutableTypeExampleSeq received_data,
      ...
      public void take_instance_w_condition(MutableTypeExampleSeq received_data,
              SampleInfoSeq info_seq, int max_samples,
              InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(MutableTypeExampleSeq received_data,
            SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(MutableTypeExampleSeq received_data,
            SampleInfoSeq info_seq, int max_samples,
            InstanceHandle_t a_handle, int sample_states, int view_states,
            int instance_states) {
    ...
    public void read_next_instance_w_condition(MutableTypeExampleSeq received_data,
            SampleInfoSeq info_seq, int max_samples,
            InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(MutableTypeExampleSeq received_data,
            SampleInfoSeq info_seq, int max_samples,
            InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(MutableTypeExampleSeq received_data, SampleInfoSeq info_seq) {
    ...
    /*package*/ MutableTypeExampleDataReader(long native_reader, DataReaderListener listener,

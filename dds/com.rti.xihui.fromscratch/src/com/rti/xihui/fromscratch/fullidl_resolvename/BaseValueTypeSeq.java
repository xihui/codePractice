...
/**
 * A sequence of BaseValueType instances.
 */
public final class BaseValueTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public BaseValueTypeSeq() {
        super(BaseValueType.class);
    }


    public BaseValueTypeSeq(int initialMaximum) {
        super(BaseValueType.class, initialMaximum);
    }


    public BaseValueTypeSeq(Collection elements) {
        super(BaseValueType.class, elements);
    }

...
public class DerivedValueTypeTypeSupport extends TypeSupportImpl {
    ...
    public static final int LAST_MEMBER_ID = 
        (com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.LAST_MEMBER_ID + 1);
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        if(include_encapsulation) {
            ...
            currentAlignment += com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        currentAlignment += com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().get_serialized_key_max_size(
            endpoint_data,
...
DerivedValueType typedSrc = (DerivedValueType) src;    
        com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
DerivedValueType typedSrc = (DerivedValueType) src;    
com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().serialize_key(
...
DerivedValueType typedDst = (DerivedValueType) dst;
            ...
            typedDst.clear();        com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
...
com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().deserialize_key_sample(
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
...
DerivedValueType typedDst = (DerivedValueType) sample;
        ...
        com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().serialized_sample_to_key(endpoint_data,sample,
                                 src,false, true,
                                 endpoint_plugin_qos);
    ...
    public void key_to_instance(Object endpoint_data,
        ...
        com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().key_to_instance(endpoint_data,instance,key);
    ...
    public void instance_to_key(Object endpoint_data,
        ...
        DerivedValueType typedSrc
            = (DerivedValueType) instance;
        com.rti.xihui.fromscratch.fullidl_resolvename.BaseValueTypeTypeSupport.get_instance().instance_to_key(endpoint_data,key,instance);

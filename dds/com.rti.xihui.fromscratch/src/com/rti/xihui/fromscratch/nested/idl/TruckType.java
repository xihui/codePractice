...
public class TruckType implements Copyable, Serializable
{
    ...
    public String plate = ""; /* maximum length = ((PLATE_MAXLEN.VALUE)) */
    public String nickNamek = ""; /* maximum length = ((NAME_MAXLEN.VALUE)) */
    public StateKind state = (StateKind) StateKind.create();
    ...
    public Object copy_from(Object src) {
        ...
        typedDst.state = (StateKind) typedDst.state.copy_from(typedSrc.state);

...
/**
 * A sequence of TruckType instances.
 */
public final class TruckTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public TruckTypeSeq(int initialMaximum) {
        super(TruckType.class, initialMaximum);
    }


    public TruckTypeSeq(Collection elements) {
        super(TruckType.class, elements);
    }

...
/**
 * A sequence of ServiceKind instances.
 */
public final class ServiceKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ServiceKindSeq() {
        super(ServiceKind.class);
    }


    public ServiceKindSeq(int initialMaximum) {
        super(ServiceKind.class, initialMaximum);
    }


    public ServiceKindSeq(Collection elements) {
        super(ServiceKind.class, elements);
    }

 ...
 * ServiceType.
 */
public class ServiceTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ServiceType";
    ...
    private static final ServiceTypeTypeSupport _singleton
        = new ServiceTypeTypeSupport();
     ...
     */
    public static ServiceTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static ServiceTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>ServiceType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        ServiceType typedDst = (ServiceType) destination;
        ServiceType typedSrc = (ServiceType) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((VIN_MAXLEN.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment +=  ServiceKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((REMARKS_MAXLEN.VALUE))) + 1);
            
        currentAlignment +=  FuelGaugeTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  LongLatTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ServiceKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
            
        currentAlignment +=  FuelGaugeTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  LongLatTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        ServiceType typedSrc = (ServiceType) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.VIN);
            
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += ServiceKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.kind);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.remarks);
            
        currentAlignment += FuelGaugeTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.fuelgauge);
            
        currentAlignment += LongLatTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.position);
...
ServiceType typedSrc = (ServiceType) src;    
        ...
        dst.writeString(typedSrc.VIN,((VIN_MAXLEN.VALUE)));
            
        dst.writeInt(typedSrc.date);        
            
        ServiceKindTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        dst.writeString(typedSrc.remarks,((REMARKS_MAXLEN.VALUE)));
            
        FuelGaugeTypeTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.fuelgauge, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        LongLatTypeTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.position, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
ServiceType typedDst = (ServiceType) dst;
        
            typedDst.clear();
    try {

            typedDst.VIN = src.readString(((VIN_MAXLEN.VALUE)));
            
            typedDst.date = src.readInt();
            
            typedDst.kind = (ServiceKind)ServiceKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);            
            
            typedDst.remarks = src.readString(((REMARKS_MAXLEN.VALUE)));
            
            typedDst.fuelgauge = (FuelGaugeType)FuelGaugeTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.fuelgauge, src, false, true, endpoint_plugin_qos);            
            
            typedDst.position = (LongLatType)LongLatTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.position, src, false, true, endpoint_plugin_qos);            
...
ServiceType typedDst = (ServiceType) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            ServiceKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            
            src.skipString();
            
            FuelGaugeTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            
            LongLatTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
ServiceType typedDst = (ServiceType) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        ServiceType typedDst
            = (ServiceType) instance;
        ServiceType typedSrc
            = (ServiceType) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new ServiceTypeDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new ServiceTypeDataReader(native_reader, listener, mask, this);                
    ...
    protected ServiceTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,ServiceTypeTypeCode.VALUE,ServiceType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected ServiceTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,ServiceTypeTypeCode.VALUE,ServiceType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

 ...
 * HelloMsg.
 */
public class HelloMsgTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "HelloMsg";
    ...
    private static final HelloMsgTypeSupport _singleton
        = new HelloMsgTypeSupport();
     ...
     */
    public static HelloMsgTypeSupport get_instance() {
        return _singleton;
    }

    public static HelloMsgTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return HelloMsg.create();
    }
     ...
     * <code>this</code> is not a <code>HelloMsg</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        HelloMsg typedDst = (HelloMsg) destination;
        HelloMsg typedSrc = (HelloMsg) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.xihui.fromscratch.idl.MAX_MSG_LENGTH.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, ((com.rti.xihui.fromscratch.idl.SEQ_LENGTH.VALUE)));
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        HelloMsg typedSrc = (HelloMsg) sample;
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceSerializedSize(currentAlignment, typedSrc.mySeq);
...
HelloMsg typedSrc = (HelloMsg) src;    
        ...
        dst.writeString(typedSrc.msg,((com.rti.xihui.fromscratch.idl.MAX_MSG_LENGTH.VALUE)));
            
        dst.writeIntSeq(typedSrc.mySeq,((com.rti.xihui.fromscratch.idl.SEQ_LENGTH.VALUE)));
...
HelloMsg typedDst = (HelloMsg) dst;
    ...
    try {
            ...
            typedDst.msg = src.readString(((com.rti.xihui.fromscratch.idl.MAX_MSG_LENGTH.VALUE)));
            
            src.readIntSequence(
                typedDst.mySeq,
                ((com.rti.xihui.fromscratch.idl.SEQ_LENGTH.VALUE)));
...
HelloMsg typedDst = (HelloMsg) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
HelloMsg typedDst = (HelloMsg) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new HelloMsgDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new HelloMsgDataReader(native_reader, listener, mask, this);                
    ...
    protected HelloMsgTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,HelloMsgTypeCode.VALUE,HelloMsg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected HelloMsgTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,HelloMsgTypeCode.VALUE,HelloMsg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

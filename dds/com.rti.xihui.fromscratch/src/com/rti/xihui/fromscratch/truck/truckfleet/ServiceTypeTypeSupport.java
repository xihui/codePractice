...
public class ServiceTypeTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "truckfleet::ServiceType";
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.truck.truckfleet.ServiceKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.xihui.fromscratch.truck.truckfleet.REMARKS_MAXLEN.VALUE))) + 1);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.truck.truckfleet.ServiceKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        currentAlignment += com.rti.xihui.fromscratch.truck.truckfleet.ServiceKindTypeSupport.get_instance().get_serialized_sample_size(
...
ServiceType typedSrc = (ServiceType) src;    
        ...
        com.rti.xihui.fromscratch.truck.truckfleet.ServiceKindTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        dst.writeString(typedSrc.remarks,((com.rti.xihui.fromscratch.truck.truckfleet.REMARKS_MAXLEN.VALUE)));
...
ServiceType typedDst = (ServiceType) dst;
    ...
    try {
            ...
            typedDst.kind = (com.rti.xihui.fromscratch.truck.truckfleet.ServiceKind)com.rti.xihui.fromscratch.truck.truckfleet.ServiceKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);            
            
            
            typedDst.remarks = src.readString(((com.rti.xihui.fromscratch.truck.truckfleet.REMARKS_MAXLEN.VALUE)));
...
ServiceType typedDst = (ServiceType) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.xihui.fromscratch.truck.truckfleet.ServiceKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

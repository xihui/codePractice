 ...
 * StateKind.
 */
public class StateKindTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::StateKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final StateKindTypeSupport _singleton
        = new StateKindTypeSupport();    
    ...
    public static StateKindTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static StateKindTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = StateKindTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
StateKind typedSrc = (StateKind) src;   
    ...
    protected StateKindTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,StateKindTypeCode.VALUE,StateKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);

 ...
 * VINType.
 */
public class VINTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::VINType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final VINTypeTypeSupport _singleton
        = new VINTypeTypeSupport();
     ...
     */
    public static VINTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static VINTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>VINType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        VINType typedDst = (VINType) destination;
        VINType typedSrc = (VINType) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        VINType typedSrc = (VINType) sample;
...
VINType typedSrc = (VINType) src;    
        ...
        dst.writeString(typedSrc.userData,((com.rti.xihui.fromscratch.truck.truckfleet.VIN_MAXLEN.VALUE)));
...
VINType typedDst = (VINType) dst;

            typedDst.userData = src.readString(((com.rti.xihui.fromscratch.truck.truckfleet.VIN_MAXLEN.VALUE)));
...
VINType typedDst = (VINType) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
VINType typedDst = (VINType) sample;
    ...
    protected VINTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,VINTypeTypeCode.VALUE,VINType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected VINTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,VINTypeTypeCode.VALUE,VINType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

 ...
 * PlateType.
 */
public class PlateTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::PlateType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final PlateTypeTypeSupport _singleton
        = new PlateTypeTypeSupport();
     ...
     */
    public static PlateTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static PlateTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>PlateType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        PlateType typedDst = (PlateType) destination;
        PlateType typedSrc = (PlateType) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        PlateType typedSrc = (PlateType) sample;
...
PlateType typedSrc = (PlateType) src;    
        ...
        dst.writeString(typedSrc.userData,((com.rti.xihui.fromscratch.truck.truckfleet.PLATE_MAXLEN.VALUE)));
...
PlateType typedDst = (PlateType) dst;

            typedDst.userData = src.readString(((com.rti.xihui.fromscratch.truck.truckfleet.PLATE_MAXLEN.VALUE)));
...
PlateType typedDst = (PlateType) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
PlateType typedDst = (PlateType) sample;
    ...
    protected PlateTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PlateTypeTypeCode.VALUE,PlateType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected PlateTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,PlateTypeTypeCode.VALUE,PlateType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

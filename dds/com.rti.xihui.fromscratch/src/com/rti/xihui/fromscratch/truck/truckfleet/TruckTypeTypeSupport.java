 ...
 * TruckType.
 */
public class TruckTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::TruckType";
    ...
    private static final TruckTypeTypeSupport _singleton
        = new TruckTypeTypeSupport();
     ...
     */
    public static TruckTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static TruckTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>TruckType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TruckType typedDst = (TruckType) destination;
        TruckType typedSrc = (TruckType) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.xihui.fromscratch.truck.truckfleet.VIN_MAXLEN.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.xihui.fromscratch.truck.truckfleet.PLATE_MAXLEN.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.xihui.fromscratch.truck.truckfleet.NAME_MAXLEN.VALUE))) + 1);
            
        currentAlignment +=  com.rti.xihui.fromscratch.truck.truckfleet.StateKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.truck.truckfleet.StateKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TruckType typedSrc = (TruckType) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.plate);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.nickNamek);
            
        currentAlignment += com.rti.xihui.fromscratch.truck.truckfleet.StateKindTypeSupport.get_instance().get_serialized_sample_size(
...
TruckType typedSrc = (TruckType) src;    
        ...
        dst.writeString(typedSrc.VIN,((com.rti.xihui.fromscratch.truck.truckfleet.VIN_MAXLEN.VALUE)));
            
        dst.writeString(typedSrc.plate,((com.rti.xihui.fromscratch.truck.truckfleet.PLATE_MAXLEN.VALUE)));
            
        dst.writeString(typedSrc.nickNamek,((com.rti.xihui.fromscratch.truck.truckfleet.NAME_MAXLEN.VALUE)));
            
        com.rti.xihui.fromscratch.truck.truckfleet.StateKindTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.state, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
TruckType typedDst = (TruckType) dst;

    try {

            typedDst.VIN = src.readString(((com.rti.xihui.fromscratch.truck.truckfleet.VIN_MAXLEN.VALUE)));
            
            typedDst.plate = src.readString(((com.rti.xihui.fromscratch.truck.truckfleet.PLATE_MAXLEN.VALUE)));
            
            typedDst.nickNamek = src.readString(((com.rti.xihui.fromscratch.truck.truckfleet.NAME_MAXLEN.VALUE)));
            
            
            typedDst.state = (com.rti.xihui.fromscratch.truck.truckfleet.StateKind)com.rti.xihui.fromscratch.truck.truckfleet.StateKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.state, src, false, true, endpoint_plugin_qos);            
...
TruckType typedDst = (TruckType) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.xihui.fromscratch.truck.truckfleet.StateKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TruckType typedDst = (TruckType) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TruckTypeDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TruckTypeDataReader(native_reader, listener, mask, this);                
    ...
    protected TruckTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,TruckTypeTypeCode.VALUE,TruckType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TruckTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TruckTypeTypeCode.VALUE,TruckType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

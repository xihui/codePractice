...
public class ShapeTypeExtendedTypeSupport extends TypeSupportImpl {
    ...
    public static final int LAST_MEMBER_ID = 
        (ShapeTypeTypeSupport.LAST_MEMBER_ID + 2);
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += ShapeTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);

        currentAlignment +=  ShapeFillKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        if(include_encapsulation) {
            ...
            currentAlignment += ShapeTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        
        currentAlignment +=  ShapeFillKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
...
ShapeTypeExtended typedSrc = (ShapeTypeExtended) src;    
        ShapeTypeTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
        
        ShapeFillKindTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.fillKind, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
ShapeTypeExtended typedDst = (ShapeTypeExtended) dst;
            ...
            typedDst.clear();        ShapeTypeTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
...
ShapeTypeExtended typedDst = (ShapeTypeExtended) sample;
    ...
    protected ShapeTypeExtendedTypeSupport() {
        ...
        super(TYPE_NAME, false,ShapeTypeExtendedTypeCode.VALUE,ShapeTypeExtended.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

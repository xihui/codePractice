...
import org.myosgi.toast.internal.core.LogProxy;
...
public final class LogUtility extends Object {
	...
	private static final String INITIAL_LOG_LEVEL = System.getProperty(
			LogUtility.LOG_LEVEL_PROPERTY, LogUtility.DEFAULT_LOG_LEVEL);
	...
	private static boolean TRACING = Boolean.valueOf(
			System.getProperty(LogUtility.TRACE_PROPERTY,

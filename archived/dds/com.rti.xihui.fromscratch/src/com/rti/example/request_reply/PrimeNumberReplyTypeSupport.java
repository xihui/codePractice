...
public class PrimeNumberReplyTypeSupport extends TypeSupportImpl {
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, ((com.rti.example.request_reply.PRIME_SEQUENCE_MAX_LENGTH.VALUE)));
            
        currentAlignment +=  com.rti.example.request_reply.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.example.request_reply.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        currentAlignment += com.rti.example.request_reply.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_size(
...
PrimeNumberReply typedSrc = (PrimeNumberReply) src;    
        ...
        dst.writeIntSeq(typedSrc.primes,((com.rti.example.request_reply.PRIME_SEQUENCE_MAX_LENGTH.VALUE)));
            
        com.rti.example.request_reply.PrimeNumberCalculationStatusTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
PrimeNumberReply typedDst = (PrimeNumberReply) dst;
    ...
    try {
            ...
            src.readIntSequence(
                typedDst.primes,
                ((com.rti.example.request_reply.PRIME_SEQUENCE_MAX_LENGTH.VALUE)));
            
            typedDst.status = (com.rti.example.request_reply.PrimeNumberCalculationStatus)com.rti.example.request_reply.PrimeNumberCalculationStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);            
...
PrimeNumberReply typedDst = (PrimeNumberReply) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.example.request_reply.PrimeNumberCalculationStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

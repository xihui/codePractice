...
public class PrimeNumberReply implements Copyable, Serializable
{
    ...
    public IntSeq primes = new IntSeq(((com.rti.example.request_reply.PRIME_SEQUENCE_MAX_LENGTH.VALUE)));
    public com.rti.example.request_reply.PrimeNumberCalculationStatus status = (com.rti.example.request_reply.PrimeNumberCalculationStatus) com.rti.example.request_reply.PrimeNumberCalculationStatus.create();
    ...
    public void clear() {
        ...
        status = com.rti.example.request_reply.PrimeNumberCalculationStatus.create();
    ...
    public Object copy_from(Object src) {
        ...
        typedDst.status = (com.rti.example.request_reply.PrimeNumberCalculationStatus) typedDst.status.copy_from(typedSrc.status);

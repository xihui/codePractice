 ...
 * GPSInfoType.
 */
public class GPSInfoTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::GPSInfoType";
    ...
    private static final GPSInfoTypeTypeSupport _singleton
        = new GPSInfoTypeTypeSupport();
     ...
     */
    public static GPSInfoTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static GPSInfoTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>GPSInfoType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        GPSInfoType typedDst = (GPSInfoType) destination;
        GPSInfoType typedSrc = (GPSInfoType) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.truck.truckfleet.LongLatTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.truck.truckfleet.LongLatTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        GPSInfoType typedSrc = (GPSInfoType) sample;
        ...
        currentAlignment += com.rti.xihui.fromscratch.truck.truckfleet.LongLatTypeTypeSupport.get_instance().get_serialized_sample_size(
...
GPSInfoType typedSrc = (GPSInfoType) src;    
        ...
        com.rti.xihui.fromscratch.truck.truckfleet.LongLatTypeTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.position, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        dst.writeInt(typedSrc.speed);        
            
        dst.writeInt(typedSrc.direction);        
...
GPSInfoType typedDst = (GPSInfoType) dst;
    ...
    try {
            ...
            typedDst.position = (com.rti.xihui.fromscratch.truck.truckfleet.LongLatType)com.rti.xihui.fromscratch.truck.truckfleet.LongLatTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.position, src, false, true, endpoint_plugin_qos);            
            
            
            typedDst.speed = src.readInt();
            
            typedDst.direction = src.readInt();
...
GPSInfoType typedDst = (GPSInfoType) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.xihui.fromscratch.truck.truckfleet.LongLatTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
GPSInfoType typedDst = (GPSInfoType) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        GPSInfoType typedDst
            = (GPSInfoType) instance;
        GPSInfoType typedSrc
            = (GPSInfoType) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new GPSInfoTypeDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new GPSInfoTypeDataReader(native_reader, listener, mask, this);                
    ...
    protected GPSInfoTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,GPSInfoTypeTypeCode.VALUE,GPSInfoType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected GPSInfoTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,GPSInfoTypeTypeCode.VALUE,GPSInfoType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

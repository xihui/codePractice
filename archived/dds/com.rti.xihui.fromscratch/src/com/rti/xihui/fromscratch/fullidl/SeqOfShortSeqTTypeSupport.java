 ...
 * SeqOfShortSeqT.
 */
public class SeqOfShortSeqTTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::SeqOfShortSeqT";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final SeqOfShortSeqTTypeSupport _singleton
        = new SeqOfShortSeqTTypeSupport();
     ...
     */
    public static SeqOfShortSeqTTypeSupport get_instance() {
        return _singleton;
    }

    public static SeqOfShortSeqTTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return SeqOfShortSeqT.create();
    }
     ...
     * <code>this</code> is not a <code>SeqOfShortSeqT</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        SeqOfShortSeqT typedDst = (SeqOfShortSeqT) destination;
        SeqOfShortSeqT typedSrc = (SeqOfShortSeqT) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.fullidl.SeqOfShortTTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (3));
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.xihui.fromscratch.fullidl.SeqOfShortTTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        SeqOfShortSeqT typedSrc = (SeqOfShortSeqT) sample;
        ...
        currentAlignment += com.rti.xihui.fromscratch.fullidl.SeqOfShortTTypeSupport.get_instance().get_sequence_serialized_size(
...
SeqOfShortSeqT typedSrc = (SeqOfShortSeqT) src;    
        ...
        com.rti.xihui.fromscratch.fullidl.SeqOfShortTTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,(3),endpoint_plugin_qos);
...
SeqOfShortSeqT typedDst = (SeqOfShortSeqT) dst;
        
            typedDst.clear();
            com.rti.xihui.fromscratch.fullidl.SeqOfShortTTypeSupport.get_instance().deserialize_sequence(
...
SeqOfShortSeqT typedDst = (SeqOfShortSeqT) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.xihui.fromscratch.fullidl.SeqOfShortTTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
SeqOfShortSeqT typedDst = (SeqOfShortSeqT) sample;
    ...
    protected SeqOfShortSeqTTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SeqOfShortSeqTTypeCode.VALUE,SeqOfShortSeqT.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected SeqOfShortSeqTTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,SeqOfShortSeqTTypeCode.VALUE,SeqOfShortSeqT.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

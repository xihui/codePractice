...
public class PointerStruct implements Copyable, Serializable
{
    ...
    public boolean equals(Object o) {
        ...
        PointerStruct otherObj = (PointerStruct)o;



        if(member != otherObj.member) {
            return false;
        }
     ...
     * This method could be placed into <code>PointerStructTypeSupport</code>

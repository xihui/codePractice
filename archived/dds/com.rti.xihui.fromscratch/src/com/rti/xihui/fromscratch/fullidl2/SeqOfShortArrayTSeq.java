...
/**
 * A sequence of SeqOfShortArrayT instances.
 */
public final class SeqOfShortArrayTSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public SeqOfShortArrayTSeq() {
        super(SeqOfShortArrayT.class);
    }


    public SeqOfShortArrayTSeq(int initialMaximum) {
        super(SeqOfShortArrayT.class, initialMaximum);
    }


    public SeqOfShortArrayTSeq(Collection elements) {
        super(SeqOfShortArrayT.class, elements);
    }

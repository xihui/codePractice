...
/**
 * A sequence of TopStruct instances.
 */
public final class TopStructSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public TopStructSeq() {
        super(TopStruct.class);
    }


    public TopStructSeq(int initialMaximum) {
        super(TopStruct.class, initialMaximum);
    }


    public TopStructSeq(Collection elements) {
        super(TopStruct.class, elements);
    }

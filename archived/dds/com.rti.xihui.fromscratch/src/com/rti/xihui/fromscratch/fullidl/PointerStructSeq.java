...
/**
 * A sequence of PointerStruct instances.
 */
public final class PointerStructSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public PointerStructSeq() {
        super(PointerStruct.class);
    }


    public PointerStructSeq(int initialMaximum) {
        super(PointerStruct.class, initialMaximum);
    }


    public PointerStructSeq(Collection elements) {
        super(PointerStruct.class, elements);
    }

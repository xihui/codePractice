...
public class SMALL_STRINGTypeSupport extends TypeSupportImpl {
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((STRING_SIZE.VALUE))) + 1);
...
SMALL_STRING typedSrc = (SMALL_STRING) src;    
        ...
        dst.writeString(typedSrc.userData,((STRING_SIZE.VALUE)));
...
SMALL_STRING typedDst = (SMALL_STRING) dst;
            ...
            typedDst.clear();
            typedDst.userData = src.readString(((STRING_SIZE.VALUE)));

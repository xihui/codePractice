...
/**
 * A sequence of ShortArray instances.
 */
public final class ShortArraySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ShortArraySeq() {
        super(ShortArray.class);
    }


    public ShortArraySeq(int initialMaximum) {
        super(ShortArray.class, initialMaximum);
    }


    public ShortArraySeq(Collection elements) {
        super(ShortArray.class, elements);
    }

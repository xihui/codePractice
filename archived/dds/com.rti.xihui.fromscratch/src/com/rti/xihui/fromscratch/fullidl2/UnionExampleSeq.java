...
/**
 * A sequence of UnionExample instances.
 */
public final class UnionExampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public UnionExampleSeq() {
        super(UnionExample.class);
    }


    public UnionExampleSeq(int initialMaximum) {
        super(UnionExample.class, initialMaximum);
    }


    public UnionExampleSeq(Collection elements) {
        super(UnionExample.class, elements);
    }

...
/**
 * A sequence of FuelGaugeType instances.
 */
public final class FuelGaugeTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public FuelGaugeTypeSeq() {
        super(FuelGaugeType.class);
    }


    public FuelGaugeTypeSeq(int initialMaximum) {
        super(FuelGaugeType.class, initialMaximum);
    }


    public FuelGaugeTypeSeq(Collection elements) {
        super(FuelGaugeType.class, elements);
    }

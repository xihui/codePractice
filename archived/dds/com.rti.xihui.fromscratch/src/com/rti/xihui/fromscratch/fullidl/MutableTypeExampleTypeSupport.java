 ...
 * MutableTypeExample.
 */
public class MutableTypeExampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::MutableTypeExample";
    ...
    private static final MutableTypeExampleTypeSupport _singleton
        = new MutableTypeExampleTypeSupport();
     ...
     */
    public static MutableTypeExampleTypeSupport get_instance() {
        return _singleton;
    }

    public static MutableTypeExampleTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return MutableTypeExample.create();
    }
    ...
    public Class get_type() {
        return MutableTypeExample.class;
    }
     ...
     * <code>this</code> is not a <code>MutableTypeExample</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        MutableTypeExample typedDst = (MutableTypeExample) destination;
        MutableTypeExample typedSrc = (MutableTypeExample) source;
    ...
    currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        currentAlignment +=  CdrPrimitiveType.SHORT.getMaxSizeSerialized(0);
                currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        MutableTypeExample typedSrc = (MutableTypeExample) sample;
...
MutableTypeExample typedDst = (MutableTypeExample) dst;
...
MutableTypeExample typedDst = (MutableTypeExample) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
MutableTypeExample typedDst = (MutableTypeExample) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new MutableTypeExampleDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new MutableTypeExampleDataReader(native_reader, listener, mask, this);                
    ...
    protected MutableTypeExampleTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MutableTypeExampleTypeCode.VALUE,MutableTypeExample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected MutableTypeExampleTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,MutableTypeExampleTypeCode.VALUE,MutableTypeExample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

 ...
 * RemarksType.
 */
public class RemarksTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::RemarksType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final RemarksTypeTypeSupport _singleton
        = new RemarksTypeTypeSupport();
     ...
     */
    public static RemarksTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static RemarksTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>RemarksType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        RemarksType typedDst = (RemarksType) destination;
        RemarksType typedSrc = (RemarksType) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        RemarksType typedSrc = (RemarksType) sample;
...
RemarksType typedSrc = (RemarksType) src;    
        ...
        dst.writeString(typedSrc.userData,((com.rti.xihui.fromscratch.truck.truckfleet.REMARKS_MAXLEN.VALUE)));
...
RemarksType typedDst = (RemarksType) dst;

            typedDst.userData = src.readString(((com.rti.xihui.fromscratch.truck.truckfleet.REMARKS_MAXLEN.VALUE)));
...
RemarksType typedDst = (RemarksType) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
RemarksType typedDst = (RemarksType) sample;
    ...
    protected RemarksTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RemarksTypeTypeCode.VALUE,RemarksType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected RemarksTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,RemarksTypeTypeCode.VALUE,RemarksType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

 ...
 * UnionExample.
 */
public class UnionExampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::UnionExample";
    ...
    private static final UnionExampleTypeSupport _singleton
        = new UnionExampleTypeSupport();
     ...
     */
    public static UnionExampleTypeSupport get_instance() {
        return _singleton;
    }

    public static UnionExampleTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return UnionExample.create();
    }
     ...
     * <code>this</code> is not a <code>UnionExample</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        UnionExample typedDst = (UnionExample) destination;
        UnionExample typedSrc = (UnionExample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        maxSerialized = Math.max( CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment), maxSerialized);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        minSerialized = Math.min( CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment), minSerialized);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        UnionExample typedSrc = (UnionExample) sample;
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment);
            } else if (typedSrc._d == (2)){
                    
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            } else if (typedSrc._d == (3)){
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst,boolean serialize_encapsulation,
        ...
        if(serialize_sample) {
UnionExample typedSrc = (UnionExample) src;    

        dst.writeInt(typedSrc._d);        
             if (typedSrc._d == (1)){
...
UnionExample typedDst = (UnionExample) dst;
        

            typedDst._d = src.readInt();
             if (typedDst._d == (1)){
                    
            typedDst.shortMember = src.readShort();
            } else if (typedDst._d == (2)){
                    
            typedDst.longMember = src.readInt();
            } else if (typedDst._d == (3)){
...
UnionExample typedDst = (UnionExample) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
UnionExample typedDst = (UnionExample) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new UnionExampleDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new UnionExampleDataReader(native_reader, listener, mask, this);                
    ...
    protected UnionExampleTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UnionExampleTypeCode.VALUE,UnionExample.class,TypeSupportType.TST_UNION, PLUGIN_VERSION);
    
    }

    protected UnionExampleTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,UnionExampleTypeCode.VALUE,UnionExample.class,TypeSupportType.TST_UNION, PLUGIN_VERSION);
    }
}

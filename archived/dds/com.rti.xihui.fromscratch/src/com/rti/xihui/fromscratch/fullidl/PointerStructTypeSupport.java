 ...
 * PointerStruct.
 */
public class PointerStructTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::PointerStruct";
    ...
    private static final PointerStructTypeSupport _singleton
        = new PointerStructTypeSupport();
     ...
     */
    public static PointerStructTypeSupport get_instance() {
        return _singleton;
    }

    public static PointerStructTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return PointerStruct.create();
    }
     ...
     * <code>this</code> is not a <code>PointerStruct</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        PointerStruct typedDst = (PointerStruct) destination;
        PointerStruct typedSrc = (PointerStruct) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        PointerStruct typedSrc = (PointerStruct) sample;
...
PointerStruct typedDst = (PointerStruct) dst;
        
            typedDst.clear();
    try {

            typedDst.member = src.readInt();
...
PointerStruct typedDst = (PointerStruct) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
PointerStruct typedDst = (PointerStruct) sample;
    ...
    protected PointerStructTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PointerStructTypeCode.VALUE,PointerStruct.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected PointerStructTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,PointerStructTypeCode.VALUE,PointerStruct.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

...
public class TopStructTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[i]=new StructMember("primitiveStructMember",false,(short)-1,false,(TypeCode)PrimitiveStructTypeCode.VALUE,1,false); i++;
        sm[i]=new StructMember("shortArray",false,(short)-1,false,(TypeCode)ShortArrayTypeCode.VALUE,2,false); i++;

...
/**
 * A sequence of StateKind instances.
 */
public final class StateKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public StateKindSeq() {
        super(StateKind.class);
    }


    public StateKindSeq(int initialMaximum) {
        super(StateKind.class, initialMaximum);
    }


    public StateKindSeq(Collection elements) {
        super(StateKind.class, elements);
    }

...
/**
 * A sequence of LongLatType instances.
 */
public final class LongLatTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public LongLatTypeSeq() {
        super(LongLatType.class);
    }


    public LongLatTypeSeq(int initialMaximum) {
        super(LongLatType.class, initialMaximum);
    }


    public LongLatTypeSeq(Collection elements) {
        super(LongLatType.class, elements);
    }

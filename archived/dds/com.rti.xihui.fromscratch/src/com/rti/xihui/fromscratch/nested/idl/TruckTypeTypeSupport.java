...
public class TruckTypeTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "TruckType";
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((PLATE_MAXLEN.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((NAME_MAXLEN.VALUE))) + 1);
            
        currentAlignment +=  StateKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  StateKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        currentAlignment += StateKindTypeSupport.get_instance().get_serialized_sample_size(
...
TruckType typedSrc = (TruckType) src;    
        ...
        dst.writeString(typedSrc.plate,((PLATE_MAXLEN.VALUE)));
            
        dst.writeString(typedSrc.nickNamek,((NAME_MAXLEN.VALUE)));
            
        StateKindTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.state, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
TruckType typedDst = (TruckType) dst;
    ...
    try {
            ...
            typedDst.plate = src.readString(((PLATE_MAXLEN.VALUE)));
            
            typedDst.nickNamek = src.readString(((NAME_MAXLEN.VALUE)));
            
            typedDst.state = (StateKind)StateKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.state, src, false, true, endpoint_plugin_qos);            
...
TruckType typedDst = (TruckType) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            StateKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

...
/**
 * A sequence of EnumExample instances.
 */
public final class EnumExampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public EnumExampleSeq() {
        super(EnumExample.class);
    }


    public EnumExampleSeq(int initialMaximum) {
        super(EnumExample.class, initialMaximum);
    }


    public EnumExampleSeq(Collection elements) {
        super(EnumExample.class, elements);
    }

 ...
 * LongLatType.
 */
public class LongLatTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "LongLatType";
    ...
    private static final LongLatTypeTypeSupport _singleton
        = new LongLatTypeTypeSupport();
     ...
     */
    public static LongLatTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static LongLatTypeTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return LongLatType.create();
    }
     ...
     * <code>this</code> is not a <code>LongLatType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        LongLatType typedDst = (LongLatType) destination;
        LongLatType typedSrc = (LongLatType) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        LongLatType typedSrc = (LongLatType) sample;
...
LongLatType typedSrc = (LongLatType) src;    
        ...
        dst.writeFloat(typedSrc.longtitude);        
            
        dst.writeFloat(typedSrc.latitude);        
...
LongLatType typedDst = (LongLatType) dst;
        
            typedDst.clear();
    try {

            typedDst.longtitude = src.readFloat();
            
            typedDst.latitude = src.readFloat();
...
LongLatType typedDst = (LongLatType) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
LongLatType typedDst = (LongLatType) sample;
    ...
    protected LongLatTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongLatTypeTypeCode.VALUE,LongLatType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected LongLatTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,LongLatTypeTypeCode.VALUE,LongLatType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

...
/**
 * A sequence of DerivedValueType instances.
 */
public final class DerivedValueTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public DerivedValueTypeSeq() {
        super(DerivedValueType.class);
    }


    public DerivedValueTypeSeq(int initialMaximum) {
        super(DerivedValueType.class, initialMaximum);
    }


    public DerivedValueTypeSeq(Collection elements) {
        super(DerivedValueType.class, elements);
    }

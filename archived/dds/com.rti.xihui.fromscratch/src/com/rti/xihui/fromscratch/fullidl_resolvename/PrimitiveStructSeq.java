...
/**
 * A sequence of PrimitiveStruct instances.
 */
public final class PrimitiveStructSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public PrimitiveStructSeq() {
        super(PrimitiveStruct.class);
    }


    public PrimitiveStructSeq(int initialMaximum) {
        super(PrimitiveStruct.class, initialMaximum);
    }


    public PrimitiveStructSeq(Collection elements) {
        super(PrimitiveStruct.class, elements);
    }

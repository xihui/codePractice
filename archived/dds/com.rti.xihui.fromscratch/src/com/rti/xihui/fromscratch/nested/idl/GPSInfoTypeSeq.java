...
/**
 * A sequence of GPSInfoType instances.
 */
public final class GPSInfoTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public GPSInfoTypeSeq() {
        super(GPSInfoType.class);
    }


    public GPSInfoTypeSeq(int initialMaximum) {
        super(GPSInfoType.class, initialMaximum);
    }


    public GPSInfoTypeSeq(Collection elements) {
        super(GPSInfoType.class, elements);
    }

 ...
 * FuelGaugeType.
 */
public class FuelGaugeTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::FuelGaugeType";
    ...
    private static final FuelGaugeTypeTypeSupport _singleton
        = new FuelGaugeTypeTypeSupport();
     ...
     */
    public static FuelGaugeTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static FuelGaugeTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>FuelGaugeType</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        FuelGaugeType typedDst = (FuelGaugeType) destination;
        FuelGaugeType typedSrc = (FuelGaugeType) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        FuelGaugeType typedSrc = (FuelGaugeType) sample;
...
FuelGaugeType typedSrc = (FuelGaugeType) src;    
        ...
        dst.writeFloat(typedSrc.mileage);        
            
        dst.writeInt(typedSrc.distToEmpty);        
...
FuelGaugeType typedDst = (FuelGaugeType) dst;
    ...
    try {
            ...
            typedDst.mileage = src.readFloat();
            
            typedDst.distToEmpty = src.readInt();
...
FuelGaugeType typedDst = (FuelGaugeType) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
FuelGaugeType typedDst = (FuelGaugeType) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        FuelGaugeType typedDst
            = (FuelGaugeType) instance;
        FuelGaugeType typedSrc
            = (FuelGaugeType) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new FuelGaugeTypeDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new FuelGaugeTypeDataReader(native_reader, listener, mask, this);                
    ...
    protected FuelGaugeTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,FuelGaugeTypeTypeCode.VALUE,FuelGaugeType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected FuelGaugeTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,FuelGaugeTypeTypeCode.VALUE,FuelGaugeType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

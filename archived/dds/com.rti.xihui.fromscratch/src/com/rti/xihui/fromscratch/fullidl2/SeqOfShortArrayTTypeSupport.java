...
public class SeqOfShortArrayTTypeSupport extends TypeSupportImpl {
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ShortArrayTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (3));
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ShortArrayTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
	...
	Object sample) 
    {
        ...
        currentAlignment += ShortArrayTypeSupport.get_instance().get_sequence_serialized_size(
...
SeqOfShortArrayT typedSrc = (SeqOfShortArrayT) src;    
        ...
        ShortArrayTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,(3),endpoint_plugin_qos);
...
SeqOfShortArrayT typedDst = (SeqOfShortArrayT) dst;
            ...
            typedDst.clear();
            ShortArrayTypeSupport.get_instance().deserialize_sequence(
...
SeqOfShortArrayT typedDst = (SeqOfShortArrayT) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            ShortArrayTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);

 ...
 * ServiceKind.
 */
public class ServiceKindTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "truckfleet::ServiceKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final ServiceKindTypeSupport _singleton
        = new ServiceKindTypeSupport();    
    ...
    public static ServiceKindTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static ServiceKindTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = ServiceKindTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
ServiceKind typedSrc = (ServiceKind) src;   
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            dst = ServiceKind.valueOf(ordinal);
    ...
    protected ServiceKindTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,ServiceKindTypeCode.VALUE,ServiceKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);

 ...
 * BaseValueType.
 */
public class BaseValueTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::xihui::fromscratch::fullidl::BaseValueType";
    ...
    private static final BaseValueTypeTypeSupport _singleton
        = new BaseValueTypeTypeSupport();
     ...
     */
    public static BaseValueTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static BaseValueTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>BaseValueType</code>
     * type.
     */
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        BaseValueType typedSrc = (BaseValueType) sample;
...
BaseValueType typedDst = (BaseValueType) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        BaseValueType typedDst
            = (BaseValueType) instance;
        BaseValueType typedSrc
            = (BaseValueType) key;
    ...
    protected BaseValueTypeTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,BaseValueTypeTypeCode.VALUE,BaseValueType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected BaseValueTypeTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,BaseValueTypeTypeCode.VALUE,BaseValueType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}

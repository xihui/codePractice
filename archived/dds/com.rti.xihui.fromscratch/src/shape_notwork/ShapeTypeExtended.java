...
public class ShapeTypeExtended extends ShapeType implements Copyable, Serializable
{

    public ShapeFillKind fillKind = (ShapeFillKind) ShapeFillKind.create();

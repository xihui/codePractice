...
public class ShapeFillKindTypeSupport extends TypeSupportImpl {    
    ...
    private static final String TYPE_NAME = "shape::ShapeFillKind";
     ...
     * So, for example:
     *    myEnumField = ShapeFillKindTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
...
ShapeFillKind typedSrc = (ShapeFillKind) src;   
    ...
    protected ShapeFillKindTypeSupport() {
            ...
            super(TYPE_NAME, false /*no key*/,ShapeFillKindTypeCode.VALUE,ShapeFillKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);

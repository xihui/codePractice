...
public class ShapeTypeExtendedTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "shape::ShapeTypeExtended";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    
    public static final int LAST_MEMBER_ID = 
        (shape.ShapeTypeTypeSupport.LAST_MEMBER_ID + 2);
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += shape.ShapeTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);

        currentAlignment +=  shape.ShapeFillKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        if(include_encapsulation) {
            ...
            currentAlignment += shape.ShapeTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        
        currentAlignment +=  shape.ShapeFillKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        currentAlignment += shape.ShapeTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,sample);

        currentAlignment += shape.ShapeFillKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.fillKind);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += shape.ShapeTypeTypeSupport.get_instance().get_serialized_key_max_size(
            endpoint_data,
...
ShapeTypeExtended typedSrc = (ShapeTypeExtended) src;    
        shape.ShapeTypeTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
        
        shape.ShapeFillKindTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.fillKind, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
ShapeTypeExtended typedSrc = (ShapeTypeExtended) src;    
shape.ShapeTypeTypeSupport.get_instance().serialize_key(
...
ShapeTypeExtended typedDst = (ShapeTypeExtended) dst;
            ...
            typedDst.clear();        shape.ShapeTypeTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
        
    try {

            typedDst.fillKind = (shape.ShapeFillKind)shape.ShapeFillKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.fillKind, src, false, true, endpoint_plugin_qos);            
...
shape.ShapeTypeTypeSupport.get_instance().deserialize_key_sample(
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
shape.ShapeTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        
            shape.ShapeFillKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
...
ShapeTypeExtended typedDst = (ShapeTypeExtended) sample;
        ...
        shape.ShapeTypeTypeSupport.get_instance().serialized_sample_to_key(endpoint_data,sample,
                                 src,false, true,
                                 endpoint_plugin_qos);
    ...
    public void key_to_instance(Object endpoint_data,
        ...
        shape.ShapeTypeTypeSupport.get_instance().key_to_instance(endpoint_data,instance,key);
    ...
    public void instance_to_key(Object endpoint_data,
        ...
        ShapeTypeExtended typedSrc
            = (ShapeTypeExtended) instance;
        shape.ShapeTypeTypeSupport.get_instance().instance_to_key(endpoint_data,key,instance);
